...
[Complete API Documentation.](http://master.typechecker.bevry.surge.sh/docs/globals.html)
...
``` typescript
import * as pkg from 'https://unpkg.com/typechecker@^7.15.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/typechecker@^7.15.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/typechecker@^7.15.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/typechecker@7.15.0'
</script>
```
...
<li><code>typechecker</code> aliases <code>typechecker/edition-esnext/index.js</code></li>
