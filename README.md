...
``` typescript
import * as pkg from 'https://unpkg.com/typechecker@^7.8.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import * as pkg from '//cdn.pika.dev/typechecker/^7.8.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/typechecker@^7.8.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/typechecker@7.8.0'
</script>
```
