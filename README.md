...
As such, for basic `==` and `===` checks (e.g. `a === null`), you're fine not using this, but for checks when you would have done `instanceof` (e.g. `err instanceof Error`), you should try to use this instead.
