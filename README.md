...
``` typescript
import * as pkg from 'https://unpkg.com/typechecker@^9.0.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/typechecker@^9.0.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/typechecker@^9.0.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/typechecker@9.0.0'
</script>
```
